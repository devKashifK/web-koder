        ...
        <div className={`${styles.aboutSkills} grid`} >
          <div className={styles.skillsData}>
            ...
            <div className={styles.skills}>
              <span className={`${styles.skillsPercentage} ${styles.development}`}></span>
            </div>
          </div>
          <div className={styles.skillsData}>
            <div className={styles.skillsTitles}>
            ...
            <div className={styles.skills}>
              <span className={`${styles.skillsPercentage} ${styles.uiDesign}`}></span>
            </div>
          </div>
          <div className={styles.skillsData}>
            <div className={styles.skillsTitles}>
            ...
            <div className={styles.skills}>
              <span className={`${styles.skillsPercentage} ${styles.photography}`}></span>
            </div>
          </div>
        </div>
        </div>
